...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        y='Automobile_Sales', title='Yearly Automobile Sales for the year {}'.format(input_year)))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(yas, x='Year',
 y='Automobile_Sales', title='Monthy Automobile Sales for the year {}'.format(input_year)))
        ...
        title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
            ...
            # Total Advertisement Expenditure for each vehicle using pie chart 
               exp_data=yearly_data.groupby(('Vehicle_Type')['Advertising_Expenditure'].sum().reset_index()                  Y_chart4 = dcc.Graph( figure=px.pie(exp_data, values= 'Advertising_Expenditure',
         names='Vehicle_Type', 
